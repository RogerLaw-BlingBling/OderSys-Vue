...
<!--                   <el-table-column prop="paymenttime" label="录入时间" sortable width="130">
                       ...
                       <el-table-column prop="orderId" label="单据编号" sortable width="120">
                       </el-table-column>
                       <el-table-column prop="pay_name" label="付款方" width="110">
                       </el-table-column>
                       <el-table-column prop="do_name" label="经手人" width="110">
                       </el-table-column>
                       <el-table-column prop="paymentterm" label="部门" width="120">
                       </el-table-column>
...
<!-- ============================================== 出款单 =================================================== -->
          ...
          <el-tab-pane label="出款单" name="second">
            ...
            <el-form :model="paragraphList" :rules="rules" ref="paragraphList" label-width="100px" class="demo-paragraphList">
                   ...
                   <div class="jilu_top">
                     <div class="block">
                         ...
                         <el-date-picker @change="p_setDate" 
                           v-model="paragraphList.paymenttime"
                           type="date"
                           placeholder="选择日期"
                           :picker-options="pickerOptions0">
                         </el-date-picker>
                   ...
                   <!-- 单据编号 -->
                     <el-form-item label="单据编号：" prop="orderId">
                       <el-input v-model="paragraphList.orderId"></el-input>
                     </el-form-item>
                   </div>
                  ...
                  <div class="jilu_content">
                   <!-- 付款单位、经手人等信息 -->
                     ...
                     <el-form-item label="付款方式" prop="paymentterm">
                       <el-select v-model="paragraphList.paymentterm" placeholder="请选择付款方式">
                         <el-option label="微信支付" value="微信支付"></el-option>
                         <el-option label="支付宝支付" value="支付宝支付"></el-option>
                         <el-option label="对公账户" value="对公账户"></el-option>
                       </el-select>
               ...
               <el-form :model="ModalsForm2" :rules="rules" ref="ModalsForm2" label-width="100px" class="demo-ModalsForm">
                     ...
                     <div class="jilu_top">
                       <div class="block">
                           ...
                           <el-date-picker @change="p_setDate2" 
                             v-model="ModalsForm2.paymenttime"
                             type="date"
                             placeholder="选择日期"
                             :picker-options="pickerOptions0">
                           </el-date-picker>
                     ...
                     <!-- 单据编号 -->
                       <el-form-item label="单据编号：" prop="orderId">
                         <el-input v-model="ModalsForm2.orderId"></el-input>
                       </el-form-item>
                     </div>
                     ...
                     <!-- 付款单位、经手人等信息 -->
                       ...
                       <el-form-item label="付款方式" prop="paymentterm">
                         <el-select v-model="ModalsForm2.paymentterm" placeholder="请选择付款方式">
                           <el-option label="微信支付" value="微信支付"></el-option>
                           <el-option label="支付宝支付" value="支付宝支付"></el-option>
                           <el-option label="对公账户" value="对公账户"></el-option>
                         </el-select>
...
<script>
    ...
    export default {
      ...
      methods: {
        ...
        //获取入款单表格数据
        getData(){
          this.$http.get(api.cwData_in,{params:{'key':this.orderId}}).then(function(response){ 
...
//-------- 入款单 -------
        ...
        setDate2(val){
          ...
          this.tableData.paymenttime = this.ModalsForm.paymenttime;
          // console.log(this.ModalsForm.paymenttime)
    ...
    //出款单增添数据表单时间
    p_setDate(val) {
      this.paragraphList.paymenttime=val;
    },

    //出款单编辑数据表单时间
    p_setDate2(val) {
      this.ModalsForm2.paymenttime=val;
      
      this.tableData2.paymenttime = this.ModalsForm2.paymenttime;
    },
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          for(var addlist2 of vm.tableData2){
            if(vm.paragraphList.orderId == addlist2.orderId){
              alert("单据编号已存在！请重新输入！")
              flag = 1;
              return flag;
              // break;
