        ...
        <el-tab-pane label="入款单" name="first">
          ...
          <div class="jilu_table">
            <el-table :data="tableData" border style="width: 100%" max-height="600">
              ...
              <el-table-column prop="orderId" label="单据编号" sortable width="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //获取入款单表格数据
    getData() {
      this.$http.get(api.cwData_in, { params: { key: this.orderId } }).then(
        function(response) {
    ...
    //获取出款单表格数据
    getData2() {
      this.$http.get(api.cwData_out).then(
        function(response) {
          // console.log(response);
